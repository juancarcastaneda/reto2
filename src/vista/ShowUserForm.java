...
Conexion conexion = new Conexion();
    ...
    public void actualizarEmpleado()
    {
        ...
        {
            //se actualiza 
            String query = "UPDATE empleados SET nombreEmp = '" + nombre +"' ,apellidos ='"+apellido + "',correo = '" + correo + "' WHERE idEmo = '"+ idEmp +"' ;";
            try 
            {
    ...
    {
        int  idEmp = Integer.parseInt(txtId.getText());
        String query = "DELETE  FROM empleados where idEmo = '" + idEmp + "';";
        try 
            {
                connection = conexion.getConnection();
                st = connection.createStatement();
